...
def get_item_price(screenshot):
    if check_is_item(screenshot):
        ...
        # img_crop = crop_image(screenshot, left=1741, top=460, right_offset=-20, bottom_offset=570)
        # img_crop = crop_image(screenshot, left=1741, top=560, right_offset=-20, bottom_offset=460)
